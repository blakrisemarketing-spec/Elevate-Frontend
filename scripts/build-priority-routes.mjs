...
const PRIORITY_ROUTES = [
  ...
  },
  {
    route: '/events/',
    outDir: 'events',
    entry: 'src/priority/pages/Events.tsx',
    component: 'EventsPage',
    title: 'Events, Bootcamps and Workshops, Elevate Career Hub',
    description: 'Explore upcoming Elevate Career Hub bootcamps and live events, plus past programmes including Job Readiness Bootcamp and Career Clarity Workshop.',
    canonical: 'https://elevatecareerhub.com/events/',
    ogImage: OG_IMAGE,
    seo: [
      breadcrumb([
      ...
      {
        '@type': 'CollectionPage',
        name: 'Events, Bootcamps and Workshops',
        description: 'Upcoming and past Elevate Career Hub bootcamps, workshops, and live career development events.',
        url: SITE_URL + '/events/',
        image: OG_IMAGE,
        publisher: { '@id': ORG['@id'] },
        mainEntity: {
          ...
          itemListElement: [
            ...
            },
            {
              ...
              item: {
                ...
                organizer: { '@id': ORG['@id'] },
                url: SITE_URL + '/job-readiness-bootcamp/',
                image: OG_IMAGE,
              },
            },
            {
