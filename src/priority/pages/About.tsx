    ...
    <>
      ...
      <main id="main">
        <PageHero
          ...
          intro={
            <>
              <p className="mb-4">Opportunity, almost everywhere, gets distributed by who you know, not what you can do. Whether you&rsquo;re applying to a top firm in Accra, chasing a master&rsquo;s at Manchester, or rebuilding a career as an immigrant in London or Toronto, the rules have always rewarded insiders.</p>
            ...
            <div className="grid gap-8 md:grid-cols-2 max-w-5xl mx-auto">
              <article className="card">
                ...
                <div className="space-y-3 text-ink-muted leading-relaxed">
                  ...
                  <p>What sets her approach apart is that none of it is theoretical. Every framework she teaches, she has lived. She knows what it takes to break into competitive spaces with no blueprint, no insider access, and no one handing you the next step, and that&rsquo;s what keeps people coming back.</p>
                </div>
              </article>
              <article className="card">
                <div className="aspect-[4/5] rounded-xl overflow-hidden mb-5 bg-primary-100">
