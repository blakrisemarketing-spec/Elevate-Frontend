    ...
    <>
      ...
      <main id="main">
        ...
        <section className="container-site py-16 lg:py-20" aria-labelledby="proof-heading">
          ...
          <figure className="max-w-3xl mx-auto card mb-12">
          ...
          <p className="text-sm font-semibold uppercase tracking-wider text-primary text-center mb-6">Hear it from past clients</p>
