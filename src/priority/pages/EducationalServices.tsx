        ...
        <section aria-labelledby="alacarte-heading">
          <div className="container-site py-16">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              />
              <PriceCard
                title="Statement of Purpose / Scholarship Essay"
                description="Our expert guidance ensures your unique story and aspirations shine through. Stand out with an essay that articulates your goals, passions, and potential for success."
                price="₵ 470"
                priceNote="500 words · 1000 words ₵ 750"
              />
            </div>
          </div>
        </section>
